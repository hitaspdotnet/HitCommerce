...
namespace Hitasp.HitCommerce.IdentityServer
{
    public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        private async Task CreateClientsAsync()
        {
            ...
            //Web Client
            var webClientId = configurationSection["HitCommerce_Web:ClientId"];
            if (!webClientId.IsNullOrWhiteSpace())
            {
                var webClientRootUrl = configurationSection["HitCommerce_Web:RootUrl"].EnsureEndsWith('/');
            ...
            {
                var webClientRootUrl = configurationSection["HitCommerce_App:RootUrl"]?.TrimEnd('/');
            ...
            {
                var swaggerRootUrl = configurationSection["HitCommerce_Swagger:RootUrl"].TrimEnd('/');
