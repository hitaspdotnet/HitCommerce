...
namespace Hitasp.HitCommerce.PublicWeb.Menus
{
    public class HitCommercePublicMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public HitCommercePublicMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<HitCommerceResource>();

            context.Menu.Items.Insert(
                0,
                new ApplicationMenuItem(
                    HitCommercePublicMenus.Home,
                    l["Menu:Home"],
                    "~/",
                    icon: "fas fa-home",
                    order: 0
