...
namespace Hitasp.HitCommerce.Migrations
{
    ...
    [Migration("20210818190913_Address")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hitasp.HitCommerce.Core.Addresses.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("CoreAddresses");
                });

            modelBuilder.Entity("Hitasp.HitCommerce.Core.Cities.City", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CoreCities");
                });

            modelBuilder.Entity("Hitasp.HitCommerce.Core.Countries.Country", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hitasp.HitCommerce.Core.Districts.District", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CoreDistricts");
                });

            modelBuilder.Entity("Hitasp.HitCommerce.Core.StateOrProvinces.StateOrProvince", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CoreStateOrProvinces");
                });
            ...
            modelBuilder.Entity("Hitasp.HitCommerce.Core.Addresses.Address", b =>
                {
                    b.HasOne("Hitasp.HitCommerce.Core.Cities.City", null)
                        .WithMany()
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Hitasp.HitCommerce.Core.Countries.Country", null)
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Hitasp.HitCommerce.Core.Districts.District", null)
                        .WithMany()
                        .HasForeignKey("DistrictId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Hitasp.HitCommerce.Core.StateOrProvinces.StateOrProvince", null)
                        .WithMany()
